...
default_cmd="bosh deploy -d cf ~/workspace/cf-deployment/cf-deployment.yml -v system_domain=${BOSH_LITE_DOMAIN} -o ~/workspace/capi-ci/cf-deployment-operations/use-latest-stemcell.yml -o ~/workspace/capi-ci/cf-deployment-operations/skip-cert-verify.yml -o ~/workspace/cf-deployment/operations/bosh-lite.yml"
